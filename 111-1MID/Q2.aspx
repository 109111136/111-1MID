...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            聯絡方式:
            <asp:RadioButtonList ID="rbl_Phone" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" RenderWhenDataEmpty="False">
            ...
            縣市與區域:
            <asp:DropDownList ID="dpl_City" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dpl_City_SelectedIndexChanged1"></asp:DropDownList>
